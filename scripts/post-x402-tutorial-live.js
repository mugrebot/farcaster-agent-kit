...
• API: http://localhost:3001 (production: clanknet.ai/api coming soon)
...
- CLANKNET: \`0x623693BefAECf61484e344fa272e9A8B82d9BB07\`
- USDC (Base): \`0x833589fcd6edb6e08f4c7c32d4f71b54bda02913\`
- API Server: \`http://localhost:3001\` (production: clanknet.ai coming soon)
...
async function requestClanknetTokens(wallet, agentId) {
  ...
  const response = await axios.post(
    'http://localhost:3001/api/request-tokens',
    {
      requestType: 'paid',
...
*Built with x402 payment protocol for seamless agent token distribution*`,
    ...
    async run() {
        ...
        console.log('=======================================');
        console.log('Endpoint: http://localhost:3001/api/request-tokens');
